...
from owl2tree import signature

from owlready2 import Thing, ClassConstruct, Restriction
...
class Ontology:
    ...
    def get_equivalentTo_axioms(self):
        ...
        for cls in self.ontology.classes():
            ...
            if cls.equivalent_to:
                ...
                for d in cls.equivalent_to:
                    labeled_expr = POWL2expr(clean_expr(d))
